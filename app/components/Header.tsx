...
export interface HeaderProps {
   ...
   */
  leftIconColor?: IconProps["iconColor"]
  /**
   ...
   */
  rightIconColor?: IconProps["iconColor"]
  /**
    ...
    <View style={[$container, $containerInsets, { backgroundColor }, $containerStyleOverride]}>
      <View style={[$wrapper, $styleOverride]}>
        <HeaderAction
          tx={leftTx}
          text={leftText}
          icon={{ name: leftIcon, iconColor: leftIconColor }}
          onPress={onLeftPress}
        ...
        <HeaderAction
          tx={rightTx}
          text={rightText}
          icon={{ name: rightIcon, iconColor: rightIconColor }}
  ...
  if (content) {
    return (
      <TouchableOpacity
        ...
        activeOpacity={0.8}
      >
        <Text variant="primaryMedium" text={content} style={$actionText} />
      </TouchableOpacity>
    )
  }
